export const CHART_HINTS = {
  ...
  icewarpMemory: 'VSZ (memoria virtual) del proceso IceWarp, no RAM residente. IceWarp 14.x lo publica como entero de 32 bits: si pasa de 2 GiB el valor llega negativo y aqui se corrige. Un servicio parado no muestra cifra.',
  ...
  icewarpKpiServices: 'Servicios IceWarp en ejecucion segun SNMP (running=1). El total son las filas de la tabla SMTP, POP3, IMAP, IM, GroupWare, FTP y Control.',
  icewarpKpiSessions: 'Suma de sesiones actuales de todos los servicios (columna SNMP svcServer). No son buzones ni usuarios unicos.',
  icewarpKpiMail: 'Mensajes SMTP recibidos y enviados en el rango elegido. Es el incremento del contador, no el total historico.',
  icewarpKpiRejected: 'Suma de rechazos SMTP del rango: fallidos, virus, spam, DNSBL, content filter y tarpit.',
  icewarpKpiPorts: 'Sonda TCP del agente a los puertos de correo (25, 587, 143, 993, 443). Abierto/cerrado y RTT no vienen de SNMP.',
  icewarpTable: 'Tabla SNMP de servicios IceWarp. Uptime es TimeTicks (se divide por 100). Virtual es VSZ, no RAM. FTP parado no muestra memoria.',
  icewarpColUptime: 'Tiempo desde que arranco ese servicio. IceWarp lo manda en TimeTicks (1/100 s); el portal lo convierte a dias y horas.',
  icewarpColSessions: 'Sesiones servidor abiertas ahora en ese servicio (SMTP, IMAP, Control, etc.).',
  icewarpColPeak: 'Maximo de sesiones servidor desde que arranco el servicio.',
  icewarpColVirtual: 'Memoria virtual (VSZ) del proceso. No es RSS. Un Control de 2,6 GB virtual suele usar ~100 MB de RAM.',
};
